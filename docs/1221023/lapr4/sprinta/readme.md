# 1221023 - João Monteiro - Sprint A - Self Assessment
...
**Justification and Evidences:** The tasks were analysed and done accordingly to the project description
...
**Justification and Evidences:** No merge conflicts throughout the whole sprint and the necessary commits were done
...
**Justification and Evidences:** Every US was discussed between the whole team in order keep things organized and concise.
...
**Justification and Evidences:** The scripts and all the code existent runs without issues
...
**Justification and Evidences:** For now there is no integration to be made
...
**Justification and Evidences:** Everything was met as expected