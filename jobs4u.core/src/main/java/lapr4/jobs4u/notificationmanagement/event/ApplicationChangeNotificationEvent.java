...
public class ApplicationChangeNotificationEvent extends DomainEventBase {
    ...
    public ApplicationChangeNotificationEvent(final String notificationState, final String notificationType,
    ...
    public String toString() {
        return "NewApplicationChangeNotification";
    }
}
