...
public class interviewModelLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "T__14", "TK_TRUE", "TK_FALSE", 
			"TK_TEXT", "TK_LETTER", "TK_DIGIT", "TK_DATE", "TK_TIME", "TK_QUEST", 
			"NEWLINE", "WS", "TEXT"
		};
	}
	...
	public interviewModelLexer(CharStream input) {
		super(input);
