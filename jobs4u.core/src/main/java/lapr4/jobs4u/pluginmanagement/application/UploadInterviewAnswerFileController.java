...
public class UploadInterviewAnswerFileController {
    ...
    public List<JobOpening> allJobOpeningsWithInterview() {
    ...
    public List<ApplicationId> checkFiles(PlugIn plugin, List<Application> applications) throws IOException {
        authz.ensureAuthenticatedUserHasAnyOf(UserRoles.POWER_USER, UserRoles.ADMIN, UserRoles.CUSTOMER_MANAGER);
        return pluginService.checkInterviewFiles(plugin, applications);
    }
}
